          ...
          <li>
            <Link to="/clients/previous-orders">
              <svg
                ...
                aria-hidden="true"
              >
                <path d="M8 0a2 2 0 0 1 2 2v1h4.5a.5.5 0 0 1 .46.302l2 4A.5.5 0 0 1 16 8v4a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V8a.5.5 0 0 1 .04-.201l2-4A.5.5 0 0 1 2.5 3H7V2a2 2 0 0 1 2-2zm3 5H5l-1.5 3H3V9h10V8h-.5L11 5zm-3-2V2a1 1 0 0 0-2 0v1h2z"/>
              </svg>
