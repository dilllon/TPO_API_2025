...
function Cart() {
  ...
  <>
    ...
    <section className="cart-container">
      <div className={'cart-message-box ' + (products.length <= 0 ? 'show' : '')}>
        <div className="cart-message">
          <h2 className='title'>Tu carrito de compras esta vacio :c</h2>
          <p className='message'>Agrega productos a tu carrito</p>
        </div>
      ...
      <div className={'cart-box ' + (products.length >= 1 ? 'show' : '')}>
        <div className="cart-message">
        ...
        <div className="cart-desc-price">
          <div className="cart-desc">
            <p className='desc'>Total de productos: {products.length}</p>
          </div>
          <div className="cart-price">
            <p className='price'>Total: ${products.reduce((acc, product) => acc + product.price, 0)}</p>
          </div>
        </div>
      </div>
    </section>
